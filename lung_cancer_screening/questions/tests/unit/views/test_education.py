...
from lung_cancer_screening.questions.models.education_response import EducationResponse, EducationValues
...
class TestPostEducation(TestCase):
    ...
    def test_post_renders_the_education_page_with_an_error_if_form_invalid(
        self
    ):
        response = self.client.post(
            reverse("questions:education"),
        ...
        self.assertContains(
            response, "What level of education have you completed?", status_code=422
        )
