...
urlpatterns = [
    ...
    path(
        ...
        AgeWhenStartedSmokingView.as_view(),
        name="age_when_started_smoking",
    ),
    path(
        "agree-to-share-information",
        TemplateView.as_view(template_name="agree_to_share_information.jinja"),
        name="agree_to_share_information",
    ),
    path("asbestos-exposure", AsbestosExposureView.as_view(), name="asbestos_exposure"),
    path(
        "call-us-to-book-an-appointment",
        BookAnAppointmentExitView.as_view(),
    ...
    path(
        ...
        CheckNeedAppointmentView.as_view(),
        name="check_need_appointment",
    ),
    path(
        "<tobacco_type>-smoking-current",
        SmokingCurrentView.as_view(),
    ...
    path(
        "relatives-age-when-diagnosed",
        RelativesAgeWhenDiagnosedView.as_view(),
        name="relatives_age_when_diagnosed",
    ),
    path(
        "respiratory-conditions",
        RespiratoryConditionsView.as_view(),
        name="respiratory_conditions",
    ),
    path(
        "periods-when-you-stopped-smoking",
        PeriodsWhenYouStoppedSmokingView.as_view(),
        name="periods_when_you_stopped_smoking",
    ),
    path(
        "types-tobacco-smoking",
        TypesTobaccoSmokingView.as_view(),
        name="types_tobacco_smoking",
    ),
    path(
        "<tobacco_type>-smoked-total-years",
        SmokedTotalYearsView.as_view(),
        name="smoked_total_years",
    ),
    path(
        "<tobacco_type>-smoking-frequency",
        SmokingFrequencyView.as_view(),
        name="smoking_frequency",
    ),
    path(
        "<tobacco_type>-smoked-amount", SmokedAmountView.as_view(), name="smoked_amount"
    ),
    path(
        "<tobacco_type>-smoking-change",
        SmokingChangeView.as_view(),
        name="smoking_change",
    ),
