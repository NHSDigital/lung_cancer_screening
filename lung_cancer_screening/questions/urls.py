...
urlpatterns = [
    ...
    path('<tobacco_type>-smoked-<level>-total-years', SmokedTotalYearsView.as_view(), name='smoked_total_years'),
    path('<tobacco_type>-smoking-frequency', SmokingFrequencyView.as_view(), name='smoking_frequency'),
    path('<tobacco_type>-smoking-<level>-frequency', SmokingFrequencyView.as_view(), name='smoking_frequency'),
    path('<tobacco_type>-smoked-amount', SmokedAmountView.as_view(), name='smoked_amount'),
    path('<tobacco_type>-smoked-<level>-amount', SmokedAmountView.as_view(), name='smoked_amount'),
