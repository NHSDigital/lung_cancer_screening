...
-- A valid response is defined as a response where the user has either submitted the questionnaire or has a response to the question "Do you need a face to face appointment?" with a value of "Yes".
