...
Feature: Smoked amount page
  ...
  Scenario: Checking responses and changing them
    ...
    Then I see "20 cigarettes per day" as a response to "Current cigarette smoking" under "Smoking history"
    And I see "/cigarettes-smoked-amount?change=True" as a link to change "Current cigarette smoking" under "Smoking history"
    ...
    And I see "20" filled in for "Roughly how many cigarettes do you smoke in a normal day?"
